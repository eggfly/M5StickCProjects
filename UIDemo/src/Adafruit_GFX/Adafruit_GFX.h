...
class Adafruit_GFX : public Print {
 ...
 public:
  ...
  virtual void drawPixel(int16_t x, int16_t y, uint32_t color) = 0;    ///< Virtual drawPixel() function to draw to the screen/framebuffer/etc, must be overridden in subclass. @param x X coordinate.  @param y Y coordinate. @param color 16-bit pixel color. 
